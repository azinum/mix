...
static i32 UI_X_PADDING           = 8;
static i32 UI_Y_PADDING           = 4;
static i32 UI_CONTAINER_X_PADDING = 8;
static i32 UI_CONTAINER_Y_PADDING = 8;
...
static char MIDI_DEVICE_PATH[MAX_CONFIG_STRING_SIZE] = "/dev/midi3";
