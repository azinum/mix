...
static Variable variables[] = {
  ...
  { "ui_x_padding", T_INT, &UI_X_PADDING, hook_default },
  { "ui_y_padding", T_INT, &UI_Y_PADDING, hook_default },
  { "ui_container_x_padding", T_INT, &UI_CONTAINER_X_PADDING, hook_default },
  { "ui_container_y_padding", T_INT, &UI_CONTAINER_Y_PADDING, hook_default },
  ...
  { "ui_title_bar_color", T_COLOR, &UI_TITLE_BAR_COLOR, hook_default },
  { "ui_interpolation_color", T_COLOR, &UI_INTERPOLATION_COLOR, hook_default },
